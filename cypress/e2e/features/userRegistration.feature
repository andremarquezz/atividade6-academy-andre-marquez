...
Funcionalidade: Cadastro de usuário
  ...
  Cenário: Deve exibir mensagem de erro ao tentar cadastrar um usuário com email menos de 4 caracteres
   Quando preencher um nome válido
   E preencher um email com menos de 4 caracteres
   E clicar no botão de Salvar
   Então devo ver a mensagem de erro indicando que o email deve ter pelo menos 4 caracteres
